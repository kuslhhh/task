          ...
          >
            <div className="space-y-1 w-full">
              {(tasksGroupedByDate[format(date, "PPP")] || []).map((task) => (
                <div
                  className="bg-zinc-700 hover:brightness-125 transition-all rounded shadow p-2 text-sm hover:cursor-pointer"
                  key={task.id}
            ...
            <div
              ...
              className={cn(
                "bg-zinc-700 text-white font-black absolute top-4 left-4 w-6 h-6 text-sm flex justify-center items-center rounded p-2 shadow opacity-0 group-hover:opacity-100 transition-all hover:cursor-pointer"
              )}
            >
              <FiPlus />
            </div>
